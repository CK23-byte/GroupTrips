...
export default function LoginPage() {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      console.error('[LoginPage] handleGoogleSignIn error:', err);
      setError('An unexpected error occurred. Please try again.');
      stopLoading();
    }
  }
  ...
  async function handleAppleSignIn() {
    ...
    try {
      ...
      console.error('[LoginPage] handleAppleSignIn error:', err);
      setError('An unexpected error occurred. Please try again.');
      stopLoading();
    }
  }
        ...
        <div className="bg-slate-800 border border-white/10 rounded-2xl p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-slate-800 text-white/50">or continue with email</span>
            </div>
          </div>
          ...
          <div className="mt-4 text-center">
            <Link to="/join" className="text-sm text-white/50 hover:text-white/70">
              Have a lobby code? Join directly
            </Link>
          </div>
        </div>
      </div>
